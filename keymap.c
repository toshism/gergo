 ...
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/BS |   A  |   S  |ALT/D |CTL/F |   G  | RMB  |           |      |   H  |CTL/J |ALT/K |   L  | ;  : |  ' "   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
...
MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_S,   LALT_T(KC_D),   LCTL_T(KC_F), KC_G, TT(TEN),       KC_TRNS,  KC_H, RCTL_T(KC_J), LALT_T(KC_K), KC_L,   KC_SCLN, KC_QUOT,
KC_RSFT,                KC_Z,  KC_X,   KC_C,           KC_V,         KC_B, KC_BTN1,       KC_BSPC,  KC_N, KC_M,         KC_COMM,      KC_DOT, KC_SLSH, KC_MINS,

         KC_RSFT, LT(SYMB, KC_BSPC),                                                                                           LT(SYMB, KC_SPC), KC_RSFT,

                                                           KC_TRNS,                       KC_TRNS,
                                   LT(NUMB, KC_ESC), LCA(KC_QUOTE),                       LT(WIN, KC_TAB), LT(NUMB, KC_ENT)),
...
KC_TRNS, KC_PERC, KC_CIRC,KC_LBRC,KC_RBRC, KC_TILD, KC_TRNS,       KC_TRNS,  KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_TRNS,
